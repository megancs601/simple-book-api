...
<template>
  <div class="space-x-4">
    <span class="font-mono text-2xl mr-2">&#8226;</span>
    <input
      v-model="editingTitle"
      class="h-[37px] border rounded px-1 border-slate-300"
      placeholder="Title"
    ...
    <button
      @click="cancelEdit"
      class="text-red-600 font-semibold cursor-pointer hover:underline"
    >
      Cancel
    </button>
  </div>
